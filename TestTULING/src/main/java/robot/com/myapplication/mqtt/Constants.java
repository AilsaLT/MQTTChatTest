...
public class Constants {
    ...
    public static final String MQTT_LIGHT_PUBLISH_CHAT_clientid = "MQTT_LIGHT_PUBLISH_CHAT";//订阅聊天信息的ID
    ...
    public static final String MQTT_LIGHT_SUBSCRIPT_CHAT_clientid = "MQTT_LIGHT_SUBSCRIPT_CHAT";//订阅聊天信息的ID
